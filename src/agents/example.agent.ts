...
export class ExampleAgent {
  ...
  private _defaultPrompt = "Você é um assistente útil e prestativo. Se o usuário pedir para criar um arquivo, use a ferramenta createFileTool para fazer isso.";
